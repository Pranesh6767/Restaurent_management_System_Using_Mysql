...
#  Oct 03, 2020 05:32:58 PM PDT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 1065x753+407+139
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $site_6_0.lab57 \
        ...
        -foreground #910b6e -text {Restaurant Management Sysytem} 
    ...
    vTcl:DefineAlias "$site_6_0.lab58" "Label2" vTcl:WidgetProc "Toplevel1" 1
    label $site_6_0.lab59 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font {-family {Segoe UI} -size 15 -weight normal -slant roman -underline 0 -overstrike 0} \
        -foreground $vTcl(actual_gui_fg) -text {Password  :} 
    vTcl:DefineAlias "$site_6_0.lab59" "Label3" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_6_0.ent60" "Entry1" vTcl:WidgetProc "Toplevel1" 1
    entry $site_6_0.ent61 \
        -background #d7d7d7 -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) -insertbackground black -width 244 
    vTcl:DefineAlias "$site_6_0.ent61" "Entry2" vTcl:WidgetProc "Toplevel1" 1
    button $site_6_0.but62 \
        ...
        -pady 0 -text BILLING 
    vTcl:DefineAlias "$site_6_0.but62" "Button1" vTcl:WidgetProc "Toplevel1" 1
    button $site_6_0.but63 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text WORKERS 
    vTcl:DefineAlias "$site_6_0.but63" "Button2" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_6_0.but62 \
        -in $site_6_0 -x 0 -relx 0.195 -y 0 -rely 0.767 -width 156 \
        -relwidth 0 -height 53 -relheight 0 -anchor nw -bordermode ignore 
    place $site_6_0.but63 \
        -in $site_6_0 -x 0 -relx 0.541 -y 0 -rely 0.767 -width 156 \
        -relwidth 0 -height 53 -relheight 0 -anchor nw -bordermode ignore 
