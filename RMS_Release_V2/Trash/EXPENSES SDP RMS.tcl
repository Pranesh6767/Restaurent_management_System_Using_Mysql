...
#  Nov 20, 2020 08:41:18 AM IST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top73 {base} {
    ...
    label $site_3_0.lab84 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {ID  :} 
    vTcl:DefineAlias "$site_3_0.lab84" "Label8_1" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_3_0.ent92" "ID_UI" vTcl:WidgetProc "Toplevel1" 1
    ...
    entry $site_3_0.ent97 \
        ...
        -insertbackground black -selectbackground blue \
        -selectforeground white -width 194 
    vTcl:DefineAlias "$site_3_0.ent97" "note_UI" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $top.fra75 \
        ...
        -height 0 -relheight 0.635 -anchor nw -bordermode ignore 
    place $top.but76 \
